package glab._5_3B.runner;

import glab._5_3B.model.Address;
import glab._5_3B.model.Cohort;
import glab._5_3B.model.Department;
import glab._5_3B.model.Teacher;
...
public class App {
    ...
    public static void manyToMany() {
        SessionFactory factory = new Configuration().configure("teacher_db_5_3B.cfg.xml").buildSessionFactory();
